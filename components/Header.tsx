...
const Header = () => {
  return (
    <div className='h-16 flex items-center justify-center border-b'>
      <nav className='w-full h-[38px] flex  items-center justify-between px-4'>
        <div className='w-full h-[24px] flex items-center justify-between'>
          ...
          <div className='w-[610px] h-[24px] text-[16px] flex items-center justify-between max-lg:hidden'>
            <Link href='/'>Home</Link>
        ...
        <div className='w-[347px] h-[38px] flex items-center justify-center '>
