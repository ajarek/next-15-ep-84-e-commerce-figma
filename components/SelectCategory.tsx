  ...
  return (
    <div className='w-full bg-background '>
      ...
      <div className=' p-1 rounded-b-md'>
        <div
          className={`px-2 py-1.5  flex items-center justify-between ju text-sm rounded cursor-pointer hover:bg-accent hover:text-accent-foreground ${
            selectedValue === 'beauty' ? 'bg-accent text-accent-foreground' : ''
          }`}
        ...
        <div
          className={`px-2 py-1.5  flex items-center justify-between  text-sm rounded cursor-pointer hover:bg-accent hover:text-accent-foreground ${
            selectedValue === 'fragrances'
        ...
        <div
          className={`px-2 py-1.5  flex items-center justify-between  text-sm rounded cursor-pointer hover:bg-accent hover:text-accent-foreground ${
            selectedValue === 'sports' ? 'bg-accent text-accent-foreground' : ''
          }`}
        ...
        <div
          className={`px-2 py-1.5  flex items-center justify-between  text-sm rounded cursor-pointer hover:bg-accent hover:text-accent-foreground ${
            selectedValue === 'pets' ? 'bg-accent text-accent-foreground' : ''
          }`}
