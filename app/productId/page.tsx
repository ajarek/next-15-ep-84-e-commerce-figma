...
const ProductId = ({
  ...
  const { products } = use(fetchProducts(48))
    ...
    <div className='w-full min-h-screen grid grid-cols-2 max-lg:grid-cols-1 gap-4 '>
      ...
      <div className='flex flex-col gap-6 p-4'>
        ...
        <p className='flex items-center gap-2'>
          ...
          <span
            className={
              product && product.stock > 0 ? 'text-green-500' : 'text-red-500'
            }
          >
        ...
        <div className='flex items-center gap-6'>
          ...
          <ButtonAddCart
            ...
            product={product}
            label='Add to cart'
            className='rounded-[2px] w-36 h-9 bg-[#DB4444] text-white hover:bg-[#E07575]/90'
          />
        </div>
